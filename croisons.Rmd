...
DataGouv recense les données publiques. CodeGouv, les codes sources produits par les administrations. Dans la vraie vie, il arrive que des codes source utilisent ou génèrent des données mais à ce jour on n'a pas fait le lien entre DataGouv et CodeGouv.

Et si on essayait de les croiser ?
